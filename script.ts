...
Array.prototype.customReduce = function (
  ...
  const startInterator =
    initalValue === null || typeof initalValue === "undefined" ? 1 : 0;
...
//filter
Array.prototype.customFilter = function (callback, thisArgs): any[] {
  if (!(callback instanceof Function)) {
    throw new Error("Not n function");
  }
...
Array.prototype.customFlat = function (depth = 1): any[] {
